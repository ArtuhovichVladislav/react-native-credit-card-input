...
const EXPIRY_INPUT_WIDTH = 110;
const CARD_NUMBER_INPUT_WIDTH =
  Dimensions.get("window").width - CONTAINER_PADDING_WIDTH;
    ...
    return (
      <View style={s.container}>
        <CreditCard
          ...
          cvc={cvc}
        />
        <View ref="Form" keyboardShouldPersistTaps="always" style={s.form}>
          <CCInput
          ...
          <View style={{ flexDirection: "row" }}>
            <CCInput
              ...
              containerStyle={[
                s.inputContainer,
                inputContainerStyle,
                { width: EXPIRY_INPUT_WIDTH, marginRight: 20 }
              ]}
            />
            {requiresCVC && (
              <CCInput
